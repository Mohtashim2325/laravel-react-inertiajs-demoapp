...
![](https://raw.githubusercontent.com/Mohtashim2325/pingcrm-react/master/screenshot.png)
...
```sh
git clone https://github.com/Mohtashim2325/pingcrm-react.git
cd pingcrm-react
```
...
- Port to React by (@Mohtashim2325)
